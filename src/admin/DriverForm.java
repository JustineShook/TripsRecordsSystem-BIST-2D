...
public class DriverForm extends javax.swing.JFrame {
    ...
    private void p_addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_p_addMouseClicked
       CreateDriverForm cdf =new CreateDriverForm();
        cdf.setVisible(true);
        cdf.remove.setEnabled(false);
        cdf.select.setEnabled(true);
        this.dispose();
    ...
    private void p_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_p_editMouseClicked
        ...
        if(rowIndex<0){
            ...
            if(rs.next()){
                ...
                crf.jDriverStatus.setSelectedItem(""+rs.getString("driver_status")); 
                crf.image.setIcon(crf.ResizeImage(rs.getString("driver_image"), null, crf.image));
                crf.oldpath = rs.getString("driver_image");
                crf.path = rs.getString("driver_image");
                crf.destination = rs.getString("driver_image");
                crf.addB.setEnabled(false);
                crf.UpdateB.setEnabled(true);
                crf.setVisible(true);
                
                if(rs.getString("driver_image").isEmpty()){
