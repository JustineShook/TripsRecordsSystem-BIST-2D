...
public class CreateTripsForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 200, 440));
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 350, 60, 30));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 410, -1, -1));
        ...
        jPanel2.add(Cancelbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 400, 80, -1));
        ...
        jPanel2.add(description, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 130, 30));

        weight.setBackground(new java.awt.Color(204, 204, 204));
        jPanel2.add(weight, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 130, 30));

        start.setBackground(new java.awt.Color(204, 204, 204));
        jPanel2.add(start, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 200, 30));

        end.setBackground(new java.awt.Color(204, 204, 204));
        jPanel2.add(end, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 200, 30));

        depart.setBackground(new java.awt.Color(204, 204, 204));
        jPanel2.add(depart, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 130, 30));

        arrival.setBackground(new java.awt.Color(204, 204, 204));
        jPanel2.add(arrival, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 220, 130, 30));

        distance.setBackground(new java.awt.Color(204, 204, 204));
        jPanel2.add(distance, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 130, 30));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel3.setText("STATUS");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, 130, 10));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel6.setText("DESCRIPTION ");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 90, 130, 10));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel7.setText("WEIGHT ");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 130, 10));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel10.setText("START LOCATION");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 150, 10));

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel15.setText("END LOCATION ");
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 140, 10));

        jLabel17.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel17.setText("DEPARTURE DATE ");
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, 130, 10));

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel18.setText("ARRIVAL DATE ");
        jPanel2.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, 130, 10));

        jLabel19.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel19.setText("DISTANCE");
        jPanel2.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, 130, 10));

        TripStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SUCCESSFUL", "PENDING" }));
        jPanel2.add(TripStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 130, 30));

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel21.setText("TRUCK ID");
        jPanel2.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 220, 10));

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel16.setText("DRIVER ID");
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 220, 10));

        jLabel23.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel23.setText("USER'S ID ");
        jPanel2.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 220, 10));

        userComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "..." }));
        jPanel2.add(userComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 130, 30));

        driverComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "..." }));
        jPanel2.add(driverComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 130, 30));

        TruckID.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "..." }));
        jPanel2.add(TruckID, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 130, 30));

        DriverName.setBackground(new java.awt.Color(204, 204, 204));
        DriverName.setEnabled(false);
        jPanel2.add(DriverName, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 130, 30));

        PlateNum.setBackground(new java.awt.Color(204, 204, 204));
        PlateNum.setEnabled(false);
        jPanel2.add(PlateNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 130, 30));

        jLabel20.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel20.setText("DRIVER NAME");
        jPanel2.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 130, 10));

        TripID.setBackground(new java.awt.Color(204, 204, 204));
        TripID.setEnabled(false);
        jPanel2.add(TripID, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 60, 30));

        jLabel22.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel22.setText("PLATE NUMBER");
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 130, 10));

        jLabel24.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel24.setText("TRIP ID");
        jPanel2.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 130, 10));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 380, 440));

        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("ADMIN TRIP FORM");
