...
import admin.CreateTripsForm;


public class tripsForm1 extends javax.swing.JFrame {
...
if (rowIndex < 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tripsForm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tripsForm1().setVisible(true);
            }
        });
    }
