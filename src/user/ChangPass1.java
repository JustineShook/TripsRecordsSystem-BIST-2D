 ...
 * @author mypc
 */
public class ChangPass1 extends javax.swing.JFrame {
 ...
 Color shok = new Color(160,3,0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangPass1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangPass1().setVisible(true);
            }
        });
    }
