...
public class AccountDetails_1 extends javax.swing.JFrame {
...
try {
        ...
        if (rs.next()) {
            AccountUpdate1 au = new AccountUpdate1();
            au.setAccountData(
                rs.getString("u_name"),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountDetails_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountDetails_1().setVisible(true);
            }
        });
    }
