 ...
 * @author mypc
 */
public class CreateTripsForm1 extends javax.swing.JFrame {

    
   
    
    
    public CreateTripsForm1() {
        initComponents();   
    ...
    try {
        ...
        Logger.getLogger(CreateTripsForm1.class.getName()).log(Level.SEVERE, null, ex);
    }
}
    }//GEN-LAST:event_addBActionPerformed

    private void CancelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelbuttonActionPerformed
        tripsForm1 uf =new tripsForm1();
        uf.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateTripsForm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateTripsForm1().setVisible(true);
            }
        });
    }
